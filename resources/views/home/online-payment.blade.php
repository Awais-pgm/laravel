...
@section('content')
    ...
    <section>
        <form method="POST" action="/make/payment" method="post">
            @csrf
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="my-2">
                                            <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                                data-key="pk_test_51MYR3xIMKFoMzTgysPQOP2vLN3xqNp10Q8qzzIG8vSGnKa89NCyMBZ1VK1r4EJRbI81jBkNghUk4qUHnyPwvmJ6E00JZub8vtR"
                                                data-name="Pay with Card" data-description="" data-image="/assets/images/mastercard.svg"
                                                data-amount="{{ $total * 100 }}" data-currency="pkr" data-label='pay with card'></script>
        </form>
        </div>
        <div>
        </div>
